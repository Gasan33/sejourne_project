...
class TTextTheme{
  ...
  static TextTheme lightTextTheme =TextTheme(
    ...
    labelSmall:const TextStyle().copyWith(fontSize: 8.0,fontWeight: FontWeight.normal,color: Colors.black.withOpacity(0.5)),
    displaySmall:const TextStyle().copyWith(fontSize: 4.0,fontWeight: FontWeight.normal,color: Colors.black.withOpacity(0.5)),
  );
